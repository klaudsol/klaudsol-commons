...
exports.assertAppIsEnabled = assertAppIsEnabled;
...
function assertAppIsEnabled(req, appName) {
  //TODO  
}
function assertUserHasPermission(req, permissionName) {
  //TODO  
}
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 4;
          return _Capability["default"].getCapabilitiesByLoggedInUser(token);
        case 4:
