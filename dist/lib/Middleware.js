...
var tokenValidator = /*#__PURE__*/function () {
  ...
  return function tokenValidator(_x, _x2) {
...
var checkToken = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          authorization = req.headers.authorization; // We need the data to be public, except for the data of the users.
          if (!(req.method === "GET" && !authorization && req.url !== "/api/admin/users")) {
            _context4.next = 3;
            break;
          }
  ...
  return function checkToken(_x7, _x8) {
...
var middleware = /*#__PURE__*/function () {
  ...
  return function middleware(_x9, _x10) {
