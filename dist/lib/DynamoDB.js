...
var DynamoDB = /*#__PURE__*/function () {
  function DynamoDB() {
    ...
    var DDBDocConfig = {
      marshallOptions: _objectSpread(_objectSpread({}, defaultMarshallOptions), marshallOptions),
      unmarshallOptions: _objectSpread(_objectSpread({}, defaultUnmarshallOptions), unmarshallOptions)
    };
