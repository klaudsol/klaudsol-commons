...
exports.serverSideLogout = serverSideLogout;
exports.sessionOptions = void 0;
exports.withSession = withSession;
var _next2 = require("iron-session/next");
...
var _process$env$KS_SECRE, _process$env$KS_SECRE2;
...
var sessionOptions = {
  password: (_process$env$KS_SECRE = process.env.KS_SECRET_COOKIE_PASSWORD) !== null && _process$env$KS_SECRE !== void 0 ? _process$env$KS_SECRE : process.env.SECRET_COOKIE_PASSWORD,
  cookieName: (_process$env$KS_SECRE2 = process.env.KS_SECRET_COOKIE_NAME) !== null && _process$env$KS_SECRE2 !== void 0 ? _process$env$KS_SECRE2 : 'klaudsol-cms',
...
function withSession(handler) {
  try {
    return (0, _next2.withIronSessionApiRoute)(handler, sessionOptions);
  } catch (ex) {
    (0, _Logger.log)(ex);
  }
}
;
function serverSideLogout(_x) {
...
function getSessionCache() {
  return (0, _next2.withIronSessionSsr)( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
      var _req$session3;
      var req, res, _req$session, _req$session2, _req$session2$cache;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            req = _ref.req, res = _ref.res;
            _context.prev = 1;
            if ((_req$session = req.session) !== null && _req$session !== void 0 && _req$session.cache) {
              _context.next = 4;
              break;
            }
          ...
          case 4:
            if (!((_req$session2 = req.session) !== null && _req$session2 !== void 0 && (_req$session2$cache = _req$session2.cache) !== null && _req$session2$cache !== void 0 && _req$session2$cache.forcePasswordChange)) {
              _context.next = 8;
              break;
            }
            _context.next = 7;
            return serverSideLogout(req);
          case 7:
            return _context.abrupt("return", {
              redirect: {
                permanent: false,
