...
var Group = /*#__PURE__*/function () {
  ...
  _createClass(Group, null, [{
    key: "all",
    value: function () {
      var _all = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var db, sql, data, records;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 4:
              data = _context.sent;
              records = data.records.map(function (_ref) {
                var _ref2 = _slicedToArray(_ref, 4),
                  id = _ref2[0].longValue,
                  name = _ref2[1].stringValue,
                  description = _ref2[2].stringValue,
                  isSystemSupplied = _ref2[3].longValue;
                return {
                  id: id,
                  name: name,
